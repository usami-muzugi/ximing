                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="my.php" class="btn btn-default btn-flat">用户信息</a>
                                </div>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="ximing.php">
                        <i class="fa fa-send"></i> <span>最新公告</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="invite.php">
                        <i class="fa fa-users"></i> <span>邀请用户</span>
                    </a>
                </li>

                <li  >
                    <a href="sys.php">
                        <i class="fa fa-align-left"></i> <span>本站状况</span>
                    </a>
                </li>
